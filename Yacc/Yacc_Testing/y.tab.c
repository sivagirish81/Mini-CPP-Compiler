...
static const char *const yytname[] =
{
  ...
  "T_return", "T_for", "T_while", "T_InputStream", "T_OutputStream",
  "T_openParenthesis", "T_closedParanthesis", "T_openFlowerBracket",
  "T_closedFlowerBracket", "T_RelationalOperator", "T_LogicalOperator",
  "T_UnaryOperator", "T_ArithmeticOperator", "T_AssignmentOperator",
  "T_BitwiseOperator", "T_Semicolon", "T_identifier", "T_numericConstants",
  "T_stringLiteral", "T_character", "T_whiteSpace", "'~'", "'^'", "'&'",
  "'|'", "'+'", "'-'", "'*'", "'/'", "AND", "OR", "NOT", "EQ", "NOTEQ",
  "GTE", "LTE", "GT", "LT", "INC", "DEC", "$accept", "Start", "expr", YY_NULLPTR
};
#endif
